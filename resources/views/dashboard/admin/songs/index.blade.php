        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Manage Songs</h3>
              <div class="card-tools">
                <a href="{{ url('/admin/song/add') }}" class="btn btn-primary">
                  <i class="fa fa-user mr-2"></i> Add new song
                </a>
              </div>
            </div>
            <!-- /.card-header -->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width: 11rem">
                      <a href="{{ url('/admin/song/edit/'.$song->id) }}" class="btn btn-info btn-sm"><i
                          class="fas fa-edit mr-2"></i> Edit</a>

                      <a href="{{ url('/admin/song/delete/'.$song->id) }}" class="btn btn-danger btn-sm"><i
