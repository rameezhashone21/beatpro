...
<body>
    ...
    <main>
        ...
        <section class="tracks py-lg-5 py-3">
            <div class="col-12  text-center py-md-5 py-3">
                <h3 class="fs-1 position-relative">Top Albums</h3>
            </div>
            <div class="container">
                <div class="row ">
                    <div class="col-lg-8 offset-lg-1">
                    ...
                    <div id="waveform"></div>
                        <div class="table-responsive my-4">
                            <table class="table">
                                ...
                                <td>  
                                <a href="{{ url('/album/'.$album->id) }}"> <img href="hello" src="../storage/albums/{{ $album->image }}" style="width:200px;height:200px;"alt="">
                                </a> 
                                </td>    
                                @endforeach 
                                </tbody>
                        ...
                        <div class="text-center">
                            <a href="{{url('all_tracks')}}" class="btn-1">All Albums</a>
                        </div>
                    </div>
                </div>
            </div>
